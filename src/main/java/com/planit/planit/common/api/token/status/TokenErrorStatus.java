package com.planit.planit.common.api.token.status;
...
public enum TokenErrorStatus implements ErrorResponse {
    ...
    INVALID_ID_TOKEN(HttpStatus.UNAUTHORIZED, "TOKEN4001", "유효하지 않은 ID 토큰입니다."),
    ...
    REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "TOKEN4004", "Refresh 토큰이 만료되었습니다. 다시 로그인해주세요."); // 새로 추가!
    ;
